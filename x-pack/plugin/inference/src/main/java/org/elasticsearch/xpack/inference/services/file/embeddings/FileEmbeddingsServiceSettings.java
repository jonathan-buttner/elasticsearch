...
import org.elasticsearch.xpack.inference.services.file.FileService;
 ...
 */
public class FileEmbeddingsServiceSettings extends FilteredXContentObject implements ServiceSettings, OpenAiRateLimitServiceSettings {
    ...
    public static FileEmbeddingsServiceSettings fromMap(Map<String, Object> map, ConfigurationParseContext context) {
    ...
    private static FileEmbeddingsServiceSettings fromPersistentMap(Map<String, Object> map) {
        ...
        return new FileEmbeddingsServiceSettings(commonFields, dimensionsSetByUser);
    }

    private static FileEmbeddingsServiceSettings fromRequestMap(Map<String, Object> map) {
        ValidationException validationException = new ValidationException();
        ...
        return new FileEmbeddingsServiceSettings(commonFields, commonFields.dimensions != null);
    }
    ...
    public FileEmbeddingsServiceSettings(
        String modelId,
        @Nullable URI uri,
        @Nullable String organizationId,
        @Nullable SimilarityMeasure similarity,
    ...
    public FileEmbeddingsServiceSettings(StreamInput in) throws IOException {
    ...
    private FileEmbeddingsServiceSettings(CommonFields fields, Boolean dimensionsSetByUser) {
        this(
            fields.modelId,
            fields.uri,
    ...
    public boolean equals(Object o) {
        ...
        FileEmbeddingsServiceSettings that = (FileEmbeddingsServiceSettings) o;
